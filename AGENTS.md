...
**Owner:** user (REDACTED_KNOWN_SECRET)
...
│   ├── stock-trading-app/      ← NSE stock trading (Python+React)
...
├── recon_reports/
│   ├── companies/               ← Per-company findings (per program)
...
## stock-trading-app (~/projects/stock-trading-app/)
